                ...
                if resume and _ck.exists():
                    ...
                    try:
                        ...
                        res_sv = dict(
                            ...
                            mean_wealth         = mc_sv["mean_wealth"],
                            median_wealth       = mc_sv["median_wealth"],
                            wealth_p05          = mc_sv["wealth_p05"],
                            wealth_p95          = mc_sv["wealth_p95"],
                            max_drawdown_mean   = mc_sv["max_drawdown_mean"],
                            initial_wealth      = 1.0,
                            target_wealth       = gm,
                            wealth_path         = [],
                            weight_path         = [],
